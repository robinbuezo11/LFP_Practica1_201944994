...
class WindowAdd(tk.Frame):
    def __init__(self, master, code=None, name=None, requisite=None, semester=None, optional=None, credit=None, status=None) -> None:
        ...
        self.__lbloptional = ttk.Label(master, text='Opcional:', background='sky blue', font='Arial 14 bold')
        ...
        self.__buttonadd = ttk.Button(master, text='Agregar')
